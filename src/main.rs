...
use formatter::{print_spell_name, print_field, print_all_fields, print_list};
...
fn main() {
    ...
    let fields: Option<Vec<&String>> = matches.get_many::<String>("field").map(|vals| vals.collect());
    let show_all = matches.get_flag("all");

    // Determine the path to the JSON file
    // let default_path = "./data/libercantiones.json";
    let default_path = "./data/libercfsg";
